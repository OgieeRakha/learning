...
def colour_print(text: str, effect: str) -> None:
    """
    Changes the colour of the `text` and then resets colour
    :param text: Strings that would be printed
    :param effect: The effect or colour that the text will have
    """
